...
type XizangCrawler struct{}

func NewXizangCrawler() *XizangCrawler {
	return &XizangCrawler{}
}

func (b *XizangCrawler) FetchData() (models.Data, error) {
	lxrod := browser.Lxrod{}
	...
	rod.Try(func() {
		...
		p.MustNavigate(browser.XizangInfoUrl)
		p.MustWaitStable()
		...
		for i, element := range table.MustElements("li") {
			...
			msg = append(msg, models.MsgSt{
				...
				Url:   browser.XizangBaseUrl + *element.MustElement("a").MustAttribute("href"),
			})
		}
	})
	data := models.Data{
